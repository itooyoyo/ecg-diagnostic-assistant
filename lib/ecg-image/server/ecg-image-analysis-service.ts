...
export type EcgImageAnalysisProvider={
  ...
  analyze(image:EcgImagePayload,options?:{signal?:AbortSignal;requestId?:string}):Promise<Omit<EcgImageAnalysisResult,"analysisId"|"source"|"model"|"extractedAt">>;
};

export class ECGImageAnalysisService{
  constructor(private readonly provider:EcgImageAnalysisProvider){}
  async analyze(image:EcgImagePayload,options?:{signal?:AbortSignal;requestId?:string}):Promise<EcgImageAnalysisResult>{
