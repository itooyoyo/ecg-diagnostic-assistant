...
test("education is collapsed and delegates to the measurement guide",()=>{assert.match(source,/FindingEducationGuide/);assert.match(source,/<summary aria-label=/);assert.match(source,/legacy-finding-education/)});
