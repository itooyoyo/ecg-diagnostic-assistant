...
Version 2の標準読影順序は、撮影品質→心拍数・規則性→P波→PQ→QRS→軸→R波進行→Q波→ST→T波→U波→QT/QTc→期外収縮・R on T→最終確認の14 STEPです。各STEPは「正常・異常・判定困難」を医師が明示し、未確認を正常扱いしません。緊急候補は途中でも警告しますが、総合診断結果は14 STEP完了後に表示します。
