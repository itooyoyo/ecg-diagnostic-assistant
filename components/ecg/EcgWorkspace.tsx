...
export function EcgWorkspace({onAuthRequired,canonicalMeasurementsEnabled=false,canonicalRateRhythmEnabled=false,canonicalBasicRhythmCandidatesEnabled=false,canonicalConductionCandidatesEnabled=false,canonicalConductionEmergencyEnabled=false,canonicalStructuralEnabled=false,canonicalQtElectrolyteEnabled=false}:{onAuthRequired?:()=>void;canonicalMeasurementsEnabled?:boolean;canonicalRateRhythmEnabled?:boolean;canonicalBasicRhythmCandidatesEnabled?:boolean;canonicalConductionCandidatesEnabled?:boolean;canonicalConductionEmergencyEnabled?:boolean;canonicalStructuralEnabled?:boolean;canonicalQtElectrolyteEnabled?:boolean}={}) {
  ...
  const integratedResult=useMemo(()=>migrateCanonicalQtElectrolyte({enabled:canonicalQtElectrolyteEnabled,legacyResult:structuralIntegratedResult,shadowInput:canonicalQtElectrolyteShadowInput}).result,[canonicalQtElectrolyteEnabled,structuralIntegratedResult,canonicalQtElectrolyteShadowInput]);
