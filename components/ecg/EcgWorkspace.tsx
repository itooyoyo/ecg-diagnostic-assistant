...
export function EcgWorkspace({onAuthRequired,canonicalMeasurementsEnabled=false,canonicalRateRhythmEnabled=false,canonicalBasicRhythmCandidatesEnabled=false,canonicalConductionCandidatesEnabled=false,canonicalConductionEmergencyEnabled=false,canonicalStructuralEnabled=false}:{onAuthRequired?:()=>void;canonicalMeasurementsEnabled?:boolean;canonicalRateRhythmEnabled?:boolean;canonicalBasicRhythmCandidatesEnabled?:boolean;canonicalConductionCandidatesEnabled?:boolean;canonicalConductionEmergencyEnabled?:boolean;canonicalStructuralEnabled?:boolean}={}) {
  ...
  const integratedResult=useMemo(()=>migrateCanonicalStructural({enabled:canonicalStructuralEnabled,legacyResult:conductionEmergencyIntegratedResult,shadowInput:canonicalStructuralShadowInput}).result,[canonicalStructuralEnabled,conductionEmergencyIntegratedResult,canonicalStructuralShadowInput]);
