...
export function EcgAuthGate({initialAuthenticated,configured,canonicalMeasurementsEnabled=false,canonicalRateRhythmEnabled=false,canonicalBasicRhythmCandidatesEnabled=false,canonicalConductionCandidatesEnabled=false,canonicalConductionEmergencyEnabled=false,canonicalStructuralEnabled=false,canonicalQtElectrolyteEnabled=false,canonicalStTIschemiaEnabled=false}:{initialAuthenticated:boolean;configured:boolean;canonicalMeasurementsEnabled?:boolean;canonicalRateRhythmEnabled?:boolean;canonicalBasicRhythmCandidatesEnabled?:boolean;canonicalConductionCandidatesEnabled?:boolean;canonicalConductionEmergencyEnabled?:boolean;canonicalStructuralEnabled?:boolean;canonicalQtElectrolyteEnabled?:boolean;canonicalStTIschemiaEnabled?:boolean}){
  ...
  if(authenticated)return <><div className="auth-toolbar"><span>限定公開・認証済み</span><button className="btn secondary" type="button" onClick={logout} disabled={busy}>ログアウト</button></div><EcgWorkspace onAuthRequired={()=>{setAuthenticated(false);void checkConfiguration()}} canonicalMeasurementsEnabled={canonicalMeasurementsEnabled} canonicalRateRhythmEnabled={canonicalRateRhythmEnabled} canonicalBasicRhythmCandidatesEnabled={canonicalBasicRhythmCandidatesEnabled} canonicalConductionCandidatesEnabled={canonicalConductionCandidatesEnabled} canonicalConductionEmergencyEnabled={canonicalConductionEmergencyEnabled} canonicalStructuralEnabled={canonicalStructuralEnabled} canonicalQtElectrolyteEnabled={canonicalQtElectrolyteEnabled} canonicalStTIschemiaEnabled={canonicalStTIschemiaEnabled}/></>;
