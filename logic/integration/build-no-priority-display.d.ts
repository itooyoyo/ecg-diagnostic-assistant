export type NoPriorityDisplay={title:string;statusLabel:string;summary:string;enteredFindings:string[];unassessedItems:string[];additionalInformation:string[]};
