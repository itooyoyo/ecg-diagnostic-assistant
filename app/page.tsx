...
export default async function Home() {
  ...
  return <EcgAuthGate initialAuthenticated={session.status==="valid"} configured={config.configured} canonicalMeasurementsEnabled={canonicalMeasurementsEnabled(process.env.ECG_CANONICAL_MEASUREMENTS_ENABLED)}/>;
}
